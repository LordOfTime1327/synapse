...
function coelix_scripts() {
	...
	// wp_enqueue_script( 'coelix-fullpage-scrolloberflow', 'https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.7/vendors/scrolloverflow.min.js', array(), '20151215', true );
	...
	// wp_enqueue_script( 'coelix-easing', get_template_directory_uri() . '/assets/js/easings.min.js', array(), '20151215', true );
	// wp_enqueue_script( 'coelix-scrolloverflow', get_template_directory_uri() . '/assets/js/scrolloverflow.min.js', array(), '20151215', true );
	// wp_enqueue_script( 'coelix-fullpage', get_template_directory_uri() . '/assets/js/fullpage.min.js', array(), '20151215', true );
	
	wp_enqueue_script( 'coelix-particles', get_template_directory_uri() . '/assets/js/particles.min.js', array(), '20151215', true );
...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Theme Offer Settings',
		'menu_title'	=> 'Offer',
...
function sy_custom_excerpt_length( $length ){
	if( is_front_page() ) {
		return 10;
	}
	else return 40;
}
add_filter( 'excerpt_length', 'sy_custom_excerpt_length' );
add_filter('excerpt_more', function($more) {
	return '...';
});

//
add_filter('navigation_markup_template', 'sy_navigation_template', 10, 2 );
function sy_navigation_template(){
